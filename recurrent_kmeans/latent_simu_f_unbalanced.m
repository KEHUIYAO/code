% simulate date with K unique values of change-points, with unbalanced group of samples.
function [z,Nj,C,tau_index]=latent_simu_f(u_v,m,l1,l2,K)
...
tau_index=[ones(1,m/4),ones(1,m/4*3)+1]';
