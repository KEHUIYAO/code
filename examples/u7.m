...
[z,Nj,C,tau_list(i,:)]=latent_simu_f_lamj3(u_v,m,l1,l2,K_d);%___________data simulation end_______________
% You can also make plots, I will show you next time
[num_list(i),group_list(i,:),centroids_list{i}]=main(z,Nj,C);
end


save 7.mat tau_list num_list group_list centroids_list
