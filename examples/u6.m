...
[z,Nj,C,tau_list(i,:)]=latent_simu_f_Cjsmall(u_v,m,lambda_k,K_d);%___________data simulation end_______________
% You can also make plots, I will show you next time
[num_list(i),group_list(i,:),centroids_list{i}]=main(z,Nj,C);
end


save 6.mat tau_list num_list group_list centroids_list
